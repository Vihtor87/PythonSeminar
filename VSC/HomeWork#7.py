...
# list1 = input('Введите строчку песТни старины Винни-Пуха: ') # ('пара-ра-рам рам-пам-папам па-ра-па-дам')
# list1 = list1.split()
# new_list = []
# for el in list1:
#     res = 0
...
#             res += 1
#     new_list.append(res)
# # print(new_list) # Проверка наполнения
...
#     val = [[operation(i, j) for j in range(1, num_columns + 1)] for i in range(1, num_rows + 1)]
#     for el in val:
#         print(*[f"{x:>3}" for x in el])
#
#
# print_operation_table(lambda x, y: x * y)